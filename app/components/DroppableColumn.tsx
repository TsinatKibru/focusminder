...
// const DroppableColumn: React.FC<DroppableColumnProps> = ({ category, tasks, onDrop }) => {
...
//   return (
//     <div ref={ref} className={`bg-white py-4 px-2 rounded-md shadow-md ${isOver ? 'bg-green-100' : ''}`}>
...
//       <div className="space-y-2 mb-4">
//         {tasks.map((task) => (
//            <DraggableTask key={task.id} task={task} category={category} />
//         ))}
//       </div>
//     </div>
//   );
